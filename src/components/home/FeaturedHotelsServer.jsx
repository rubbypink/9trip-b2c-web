          ...
          {hotels.map((hotel) => (
            ...
            >
              ...
              <div className="aspect-[16/10] relative overflow-hidden">
                ...
                {/* Star rating badge */}
                {hotel.starRating > 0 && (
                  <span className="absolute top-3 left-3 bg-background/90 backdrop-blur-sm text-yellow-600 text-xs font-semibold px-2.5 py-1 rounded-full">
              ...
              <div className="p-4">
                ...
                <h3 className="font-semibold text-foreground group-hover:text-blue-600 transition-colors line-clamp-1">
                  {hotel.name}
                </h3>

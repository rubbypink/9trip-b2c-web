  ...
  return (
    <div className="flex flex-col items-center justify-center h-full px-8 py-8">
      ...
      <div className="text-center mb-4">
        <span className="text-5xl font-bold text-primary">{(Number(avgRating) || 0).toFixed(1)}</span>
          ...
          <div className="aspect-[16/9] md:aspect-[21/9] max-h-[60vh] relative">
            ...
            {displayRating > 0 && (
              <div className="absolute top-3 right-3 z-10 flex flex-col items-center rounded-xl bg-background/90 backdrop-blur-sm px-3 py-1.5 shadow-sm">
                <span className="text-lg font-bold text-primary">{(Number(displayRating) || 0).toFixed(1)}</span>

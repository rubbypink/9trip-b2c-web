...
export default function TourFilters({ locations = [], tourTypes = [], priceRange = { min: 0, max: 50000000 }, className }) {
  ...
  const filterContent = (
    <div className="space-y-5">
      ...
      {/* Price Range */}
      <div>
        <h4 className="text-sm font-semibold text-gray-800 mb-2">Khoảng giá</h4>
      ...
      {/* Rating Filter */}
      <div>
        <h4 className="text-sm font-semibold text-gray-800 mb-2">Đánh giá</h4>
      ...
      {tourTypes.length > 0 && (
        <div>
          <h4 className="text-sm font-semibold text-gray-800 mb-2">Loại tour</h4>
      ...
      {locations.length > 0 && (
        <div>
          <h4 className="text-sm font-semibold text-gray-800 mb-2">Điểm đến</h4>
          <div className="space-y-1.5 max-h-48 overflow-y-auto">
            {locations.map((loc) => (
              <button
                key={loc.id}
    ...
    <>
      ...
      {mobileOpen && (
        <>
          ...
          <div className="fixed inset-y-0 left-0 z-50 w-80 bg-white p-6 overflow-y-auto lg:hidden shadow-xl">

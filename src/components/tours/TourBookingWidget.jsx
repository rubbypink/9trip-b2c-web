    ...
    <div className="rounded-2xl border border-border bg-card shadow-sm overflow-hidden">
      ...
      <div className="p-5 border-b border-border">
        ...
        {selectedTier?.included?.length > 0 && (
          <p className="text-xs text-muted-foreground mt-1">Bao gồm: {selectedTier.included.slice(0, 2).join(", ")}</p>
        )}
      </div>
      ...
      <div className="p-5 space-y-5">
        ...
        <div>
          ...
          <input
            ...
            min={minDate}
            className="w-full rounded-lg border border-border px-3 py-2 text-sm outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
          />
        </div>
        ...
        <div className="space-y-3">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground ml-auto">{formatCurrency(tierAdultPrice, tierCurrency)}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground ml-auto">{formatCurrency(tierChildPrice, tierCurrency)}</span>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground ml-auto">{formatCurrency(tierInfantPrice, tierCurrency)}</span>
            </div>
          </div>
        </div>
        ...
        <p className="text-xs text-center text-muted-foreground">Thanh toán an toàn, xác nhận tức thì</p>
      </div>
    </div>
  );
}

          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-0.5">
              <button
                ...
                disabled={quantity <= 1}
                className="w-7 h-7 rounded border border-slate-300 flex items-center justify-center text-sm text-slate-600 hover:bg-slate-100 disabled:opacity-30 disabled:cursor-not-allowed"
              >
                −
              </button>

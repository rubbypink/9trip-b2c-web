...
/**
 * Tour Detail Error Boundary — hiển thị khi có lỗi ở trang chi tiết tour.
 * @param {{ error: Error, reset: () => void }} props
 */
export default function TourDetailError({ error, reset }) {
  return (
    <div className="flex items-center justify-center min-h-[60vh] bg-muted px-4">
      <div className="text-center max-w-md">
        ...
        <p className="text-muted-foreground text-sm mb-2">
          Không thể tải thông tin tour. Vui lòng thử lại.
        </p>

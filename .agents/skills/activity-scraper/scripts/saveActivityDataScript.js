 ...
 *
 * Usage:
 *   node .agents/skills/activity-scraper/scripts/saveActivityDataScript.js --input=path/to/data.json
 *
...
if (!INPUT_FILE) {
  console.error("❌ Usage: node .agents/skills/activity-scraper-from-bkcom/scripts/saveActivityDataScript.js --input=path/to/data.json");
  process.exit(1);
}

 ...
 *
 * Usage:
 *   node .agents/skills/tour-scraper-from-bkcom/scripts/saveTourDataSkill.js --input=path/to/data.json
 *
...
if (!INPUT_FILE) {
  console.error("❌ Usage: node .agents/skills/tour-scraper-from-bkcom/scripts/saveTourDataSkill.js --input=path/to/data.json");
  process.exit(1);
}

 ...
 *
 * Usage:
 *   node .agents/skills/booking-scraper/scripts/saveBookingData.js --input=path/to/data.json
 *
...
// Script location: .agents/skills/booking-scraper/scripts/saveBookingData.js
...
if (!INPUT_FILE) {
  console.error("❌ Usage: node .agents/skills/booking-scraper/scripts/saveBookingData.js --input=path/to/data.json");
  process.exit(1);
}

...
// 
// 	// Map
// 	map: { type: 'object', description: 'Map coordinates', properties: { lat: { type: 'number' }, lng: { type: 'number' }, zoom: { type: 'number' } } },
// 
// 	// Contact
...
//  * @constant {Object}
//  */
// export const ACTIVITY_EXTRACT_SCHEMA = { ...schemaToExtractSchema(ACTIVITY_SCHEMA), required: ['title'] };
// 
// /**
...
//  * @constant {Object}
//  */
// export const ACTIVITY_LIST_EXTRACT_SCHEMA = schemaToListExtractSchema(ACTIVITY_LIST_ITEM_SCHEMA, 'activities', { requiredFields: ['title', 'url'] });
// 
// // ============================================================================
// // UTILITY FUNCTIONS
// // ============================================================================
...
// 	let pricing = { basePrice: null, adultPrice: null, childPrice: null, currency: 'VND', tiers: [] };
// 
// 	if (rawData.pricing) {
...
// 
// 		pricing = { basePrice, adultPrice: rawData.pricing.adultPrice || basePrice, childPrice: rawData.pricing.childPrice ?? null, currency: rawData.pricing.currency || 'VND', tiers };
// 	}
// 
